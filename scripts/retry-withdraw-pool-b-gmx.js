// Retry requestWithdraw + completeWithdraw for Pool B GMX (posId=1)
// Previous attempt hit CooldownActive — deposit and withdraw were same block.
...
async function main() {
  ...
  console.log("Adapter idle:", ethers.formatUnits(await adapter.idleUsdc(), 6));
